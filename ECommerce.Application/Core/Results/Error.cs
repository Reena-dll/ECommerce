...
public sealed record Error(string Code, string Description)
{
    ...
    public static readonly Error CategoryNotExist = new("CategoryNotExist", "The specified category does not exist.");
    ...
    public static readonly Error CategoryHasProducts = new("CategoryHasProducts", "Cannot delete category because it has associated products.");
    public static readonly Error HasSameCategory = new("HasSameCategory", "Same Category available.");
